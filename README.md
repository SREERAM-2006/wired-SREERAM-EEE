...
*BANDIT LEVEL 7*
   ...
   2. Used 'grep millionth data.txt' to find the file which contains the word "millionth"
...
*BANDIT LEVEL 11*
  ...
  1.In this level I learned how to find content which all lowercase (a-z) and uppercase (A-Z) 
    letters have been rotated by some ' x ' positions.
